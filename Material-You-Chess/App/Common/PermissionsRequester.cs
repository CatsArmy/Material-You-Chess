...
#pragma warning restore CA1416 // Validate platform compatibility
    ...
    {
        if (this.ReadMediaVisualUserSelected == Permission.Granted
            || this.ReadMediaImages == Permission.Granted && this.ReadMediaVideo == Permission.Granted
            || this.ReadExternalStorage == Permission.Granted)
        {
            return true;
        }
