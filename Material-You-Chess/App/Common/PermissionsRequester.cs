...
public class PermissionsRequester
{
    ...
    {
        READ_MEDIA_VISUAL_USER_SELECTED = Permission.Denied;
        READ_MEDIA_IMAGES = Permission.Denied;
        READ_MEDIA_VIDEO = Permission.Denied;
        READ_EXTERNAL_STORAGE = Permission.Denied;
        RequestPermissions(App);
    }
    public PermissionsRequester(FragmentActivity App)
    {
        READ_MEDIA_VISUAL_USER_SELECTED = Permission.Denied;
        READ_MEDIA_IMAGES = Permission.Denied;
        READ_MEDIA_VIDEO = Permission.Denied;
    ...
    public void RequestPermissions(FragmentActivity app)
    {
